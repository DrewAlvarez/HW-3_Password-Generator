...
function writePassword() {
  ...
  var pwLength = prompt("Choose any length (8-128) for your password.");
  
//confirm length of pw is 8-128
  if (pwLength < 8 || pwLength > 128){
    alert("Your must be between 8-128 long, please try again");
  ...
  //conirm that at least one is true
  if(pwLowercase == false && pwUppercase == false && pwNumbers == false && pwSpecialChar == false){
    alert("You must choose at least one criteria for you password! Please try again!")
    return writePassword;
  }
